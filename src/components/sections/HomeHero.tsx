...
const CARD_DEFS = [
  ...
  },
  {
    ...
    href:     "/shop",
    img:      "/images/Shop.png",
    subtitle: "Designed objects and made-to-order pieces - signed from our atelier.",
    vwLeft:   0.25,
    vhBot:    0.093,
  },
  {
    ...
    subtitle: "Text: Antonio Gemayel - designer, fabricator, founder. Lebanon-rooted, New York-based.",
    vwRight:  0.113,
    vhBot:    0.102,
  },
] as const;
