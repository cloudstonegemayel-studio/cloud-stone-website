...
const PROJECTS = [
  {
    id: "1", slug: "studio-twenty-seven", number: "01",
    title: "Studio Twenty Seven",
    status: "Completed", year: "2025",
    sketch:    "/images/design/project-draft.svg",
    thumbnail: "/images/design/27_project_img.png",
    lightText: false,
  },
  {
    id: "2", slug: "cloud-stone-bathrooms", number: "02",
    title: "Cloud Stone Bathrooms",
  ...
  {
    id: "3", slug: "gemayel-residence", number: "03",
    title: "Gemayel Residence",
    status: "In Progress", year: "2024",
    sketch:    "/images/design/project-draft.svg",
    thumbnail: "/images/frame-30.png",
    lightText: true,
  },
  {
    id: "4", slug: "the-atelier", number: "04",
    title: "The Atelier",
    status: "Preparatory Stage", year: "2025",
    sketch:    "/images/design/project-draft.svg",
    thumbnail: "/images/twenty-seven.png",
    lightText: false,
  },
  {
    id: "5", slug: "quiet-house", number: "05",
    title: "Quiet House",
...
const IMG_H   = 267;
const INFO_H  = 57;
const CARD_H  = IMG_H + INFO_H; // 324 px
...
// ── Shared card inner (handles hover photo overlay over entire card) ───────────
function CardInner({
  ...
  const inner = (
    ...
    >
      {/* ── Sketch (default state, top 267px) ── */}
      <div style={{
      ...
      {/* ── Photo overlay (covers ENTIRE card on hover) ── */}
      <div style={{
      ...
      {/* ── Info row (always visible, on top of everything) ── */}
      <div style={{
      ...
      {/* ── Cloud icon — overflows top-right ── */}
      <div style={{
...
// ── Canvas card (absolute positioned) ─────────────────────────────────────────
...
// ── Canvas view (fills the section absolutely) ─────────────────────────────────
function CanvasView({ projects }: { projects: readonly Project[] }) {
...
// ── Grid view ─────────────────────────────────────────────────────────────────
function GridView({ projects }: { projects: readonly Project[] }) {
  return (
    <div style={{
...
function FAQItem({ item, index, entered }: {
  ...
  return (
    <div style={{
      ...
      {/* Question row — fill is INSIDE the button to avoid z-index conflicts */}
      <button
        onClick={() => setOpen(o => !o)}
...
export default function DesignPage() {
  ...
  const filtered: readonly Project[] = filter === "All Projects"
    ? PROJECTS
  ...
  return (
    <div style={{ position: "relative", background: "#F0EEE9" }}>
      ...
      >
        ...
        {/* Filter bar + button — absolute at section bottom in both modes */}
