...
export function EditPageClient({
    ...
    try {
      ...
      const { error: err } = await (supabase as any)
        ...
        .update({
          ...
          project_number:    meta.project_number ? parseInt(meta.project_number, 10) : null,
          light_text:        meta.light_text,
          cover_image:       meta.cover_image        || null,
          cover_image_alt:   meta.cover_image_alt    || null,
          slider_items:      meta.slider_items,
          card_image:             meta.card_image             || null,
          card_image_alt:         meta.card_image_alt         || null,
          card_hover_image:       meta.card_hover_image       || null,
          card_hover_image_alt:   meta.card_hover_image_alt   || null,
          section2_image:         meta.section2_image         || null,
          section2_image_alt:     meta.section2_image_alt     || null,
          section4_image:         meta.section4_image         || null,
          section4_image_alt:     meta.section4_image_alt     || null,
  ...
  return (
    <div style={{ display: "flex", flex: 1, overflow: "hidden", minHeight: 0 }}>
      ...
      {/* ── Center: editor ───────────────────────────────────────────────────── */}
      <div style={{ flex: 1, display: "grid", gridTemplateRows: "auto 1fr", overflow: "hidden", minWidth: 0 }}>
